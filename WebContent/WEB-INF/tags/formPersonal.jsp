<div>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-4">
      <div class="form-check form-check-inline">
        ...
        <label class="form-check-label" for="personal0">Sí</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" name="personal0" type="radio" value="no">
        <label class="form-check-label" for="personal0">No</label>
      </div>
    </div>
  </div>
  <br>
  <div class="from-group">
    ...
    <input type="text" class="form-control" name="personal1" required>
  </div>
  <br>
  <div class="row">
    <div class="col-sm-12 col-md-8">
    ...
    <div class="col-sm-12 col-md-4">
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" id="personal2" value="si">
      </div>
    </div>
  </div>
  <br>
  <div class="row">
    ...
    <div class="col-sm-12 col-md-4">
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" id="personal3" value="si">
      </div>
    </div>
  </div>
  <br>
  <div class="row">
    ...
    <div class="col-sm-12 col-md-4">
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" id="personal4" value="si">
      </div>
    </div>
  </div>
  <br>
  <div class="row">
    <div class="col-sm-12 col-md-8">
      Explique los sistemas de información previstos para garantizar este hecho y si los participantes dispondrán de una
      hoja informativa en la que quede claramente indicada esta información.
    </div>
    <div class="col-sm-12 col-md-4">
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" id="personal5" value="si">
      </div>
    </div>
  </div>
  <br>
  <div class="row">
    <div class="col-sm-12 col-md-8">
      Se les informará de que su participación es voluntaria y libre, así como de que pueden retirarse en todo momento,
      con la consecuente e inmediata eliminación de todos sus registros generados hasta ese momento.
    </div>
    <div class="col-sm-12 col-md-4">
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" id="personal6" value="si">
      </div>
    </div>
  </div>
  <br>
  <div class="row">
    ...
    <div class="col-sm-12 col-md-4">
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" id="personal7" value="si">
      </div>
    </div>
  </div>
  <br>
  <div class="row">
    ...
    <div class="col-sm-12 col-md-4">
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" id="personal8" value="si">
      </div>
    </div>
  </div>
  <br>
  <div class="row">
    ...
    <div class="col-sm-12 col-md-4">
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" id="personal9" value="si">
      </div>
    </div>
  </div>
  <br>
  <div class="row">
    ...
    <div class="col-sm-12 col-md-4">
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" id="personal10" value="si">
      </div>
    </div>
  </div>
  <br>
  <div class="row">
    <div class="col-sm-12 col-md-8">
      Se respetará el anonimato. La identidad no será relevada si no es bajo consentimiento explícito o bien en el caso
    ...
    <div class="col-sm-12 col-md-4">
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" id="personal11" value="si">
      </div>
    </div>
  </div>
  <br>
  <div class="row">
    ...
    <div class="col-sm-12 col-md-4">
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" id="personal12" value="si">
      </div>
    </div>
  </div>
  <br>
  ...
  <div class="row">
    ...
    <div class="form-check form-check-inline" style="margin: 10px 0;">
      <textarea name="personal13" id="nuevo-proy-textarea" cols="2000" rows="2" style="width: 100%; padding: 5px;"
        placeholder="En caso afirmativo, realice una breve descripción de ese tratamiento"></textarea>
    </div>
  </div>
  <br>
  <div class="from-group">
  ...
  <div class="from-group">
    ...
    <input type="text" class="form-control" name="personal15" required>
  </div>
  <br>
  <div class="from-group">
    <label for="titulo">¿Cuándo se colectan los datos personales?</label>
    <input type="text" class="form-control" name="personal16" required>
  </div>
  <br>
  <div class="from-group">
    ...
    <input type="text" class="form-control" name="personal17" required>
  </div>
  <br>
  <div class="from-group">
    ...
    <input type="text" class="form-control" name="personal18" required>
  </div>
  <br>
  <div class="from-group">
    <label for="titulo">¿En qué lugar o lugares se almacenan los datos personales y cuáles son sus soportes físicos? (PC
      fijo o portátil, equipo off-line, servidor en red, repositorio en la nube, discos magnéticos removibles, memorias
      USBs, DVD/CDs, papel, etc.)</label>
    <input type="text" class="form-control" name="personal19" required>
  </div>
  <br>
  <div class="from-group">
    <label for="titulo">¿Cómo se recuperan los datos? (acceso directo al ordenador, conexión remota, obtención de
      copias, etc.)</label>
    <input type="text" class="form-control" name="personal20" required>
  </div>
  <br>
  <div class="from-group">
    <label for="titulo">¿Se pueden recuperar los datos personales a través de una red o a través de Internet?</label>
    <input type="text" class="form-control" name="personal21" required>
  </div>
  <br>
  <div class="from-group">
    ...
    <input type="text" class="form-control" name="personal22" required>
  </div>
  <br>
  <div class="from-group">
    <label for="titulo">¿Cuándo se recuperan datos y para qué fin?</label>
    <input type="text" class="form-control" name="personal23" required>
  </div>
  <br>
  <div class="from-group">
    ...
    <input type="text" class="form-control" name="personal24" required>
  </div>
  <br>
  <div class="from-group">
    <label for="titulo">¿Para qué se recuperan los datos personales y cómo se procesan?</label>
    <input type="text" class="form-control" name="personal25" required>
  </div>
  <br>
  <div class="from-group">
    <label for="titulo">¿Los resultados que se obtiene de su procesado, pueden considerarse a su vez datos personales
      según la ley?</label>
    <input type="text" class="form-control" name="personal126" required>
  </div>
  <br>
  <div class="from-group">
    <label for="titulo">¿Qué registros indelebles generan las operaciones de almacenamiento y recuperación? (sistema de
      log o bitácoras)</label>
    <input type="text" class="form-control" name="personal27" required>
  </div>
  <br>
  <div class="from-group">
    <label for="titulo">¿Qué medidas anti-modificación tienen esos registros de actividad? ¿Qué impide que alguien pueda
      cambiarlos o impedir que se generen?</label>
    <input type="text" class="form-control" name="personal28" required>
  </div>
  <br>
  <div class="from-group">
    <label for="titulo">¿Dónde y cómo se almacenan los registros de acceso a los datos personales?</label>
    <input type="text" class="form-control" name="personal29" required>
  </div>
  <br>
  <div class="from-group">
    <label for="titulo">Indicar con detalle cómo se hacen anónimos los datos personales recolectados o los derivados de
      ellos.</label>
    <input type="text" class="form-control" name="personal130" required>
  </div>
  <br>
  <div class="from-group">
    <label for="titulo">¿Cómo se transportan los datos personales en su comunicación a los usuarios o servicios que los
      procesen?</label>
    <input type="text" class="form-control" name="personal31" required>
  </div>
  <br>
  <div class="from-group">
    <label for="titulo">¿Cómo se identifican a los destinatarios de dichas transferencias?</label>
    <input type="text" class="form-control" name="personal32" required>
  </div>
  <br>
  <div class="from-group">
    <label for="titulo">¿Qué medidas concretas se toman para evitar fugas de información?</label>
    <input type="text" class="form-control" name="personal33" required>
  </div>
  <br>
  <div class="from-group">
    <label for="titulo">¿Si se utilizan repositorios de información conectados a Internet es necesario saber cómo se
      protege la confidencialidad de su contenido, su integridad y cómo se controla quién y cuándo accede a los mismos?
      (Dropbox, Google Drive, Amazon S3, Azure, iCloud, Box, etc.)</label>
    <input type="text" class="form-control" name="personal134" required>
  </div>
  <br>
  <div class="from-group">
    ...
    <input type="text" class="form-control" name="personal35" required>
  </div>
  <br>
  <div class="from-group">
    ...
    <input type="text" class="form-control" name="personal36" required>
  </div>
</div>