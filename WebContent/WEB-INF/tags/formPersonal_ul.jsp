...
<div class="container">
  ...
  <div>
    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-md-4">
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" id="personal" value="si">
        </div>
      </div>
    </div>
    <br>
  ...
  <div>
    <div class="row">
      ...
      <div class="form-check form-check-inline" style="margin: 10px 0;">
        <textarea name="personal" id="nuevo-proy-textarea" cols="2000" rows="2" style="width: 100%; padding: 5px;"
