...
<div class="container">
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="form-check form-check-inline" style="margin: 10px 0;">
				<textarea name="biomedica0" id="nuevo-proy-textarea" cols="1996" rows="4"
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="form-check form-check-inline" style="margin: 10px 0;">
				<textarea name="biomedica1" id="nuevo-proy-textarea" cols="1996" rows="4"
	...
	<div class="row">
		<div class="col-sm-12 justify-content-between">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica12" type="checkbox" value="5">
	...
	<div class="row">
		<div class="col-sm-12 justify-content-between">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica13" type="checkbox" value="5">
	...
	<div class="row">
		<div class="col-sm-12 justify-content-between">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica14" type="checkbox" value="6">
				<label class="form-check-label" for="biomedica">Se les informaró de que su participación es voluntaria y
					libre, asá como de que pueden retirarse en todo momento.</label>
			</div>
		</div>
	</div>
	<br>
	<div class="row">
		<div class="col-sm-12 justify-content-between">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica15" type="checkbox" value="7">
				<label class="form-check-label" for="biomedica">Se dará a conocer el contacto del comité de ética a todos los
					participantes (secretaria.adjunto.vinvestigacion@upm.es).</label>
			</div>
		</div>
	</div>
	<br>
	<div class="row">
		<div class="col-sm-12 justify-content-between">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica16" type="checkbox" value="8">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica18" type="checkbox" value="10">
	...
	<div class="row">
		<div class="col-sm-12 col-md-8">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica24" type="checkbox" value="1">
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica25" type="checkbox" value="2">
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica26" type="checkbox" value="3">
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica27" type="checkbox" value="4">
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica28" type="checkbox" value="5">
