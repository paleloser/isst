...
<div class="container">
  ...
  <div>
    ...
    <div class="from-group">
      ...
      <input type="text" class="form-control" name="personal26" required>
    </div>
    <br>
    <div class="from-group">
    ...
    <div class="from-group">
      ...
      <input type="text" class="form-control" name="personal30" required>
    </div>
    <br>
    <div class="from-group">
    ...
    <div class="from-group">
      ...
      <input type="text" class="form-control" name="personal34" required>
    </div>
    <br>
    <div class="from-group">
    ...
    <div class="from-group">
      ...
      <input type="text" class="form-control" name="personal37" required>
    </div>
  </div>
</div>