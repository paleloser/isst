...
<div class="container">
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="form-check form-check-inline" style="margin: 10px 0;">
				<textarea name="biomedica" id="nuevo-proy-textarea" cols="1996" rows="2"
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="form-check form-check-inline" style="margin: 10px 0;">
				<textarea name="biomedica" id="nuevo-proy-textarea" cols="1996" rows="2" style="width: 100%; padding: 5px;"
	...
	<div class="row">
		<div class="col-sm-12 justify-content-between">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica" type="checkbox" value="1">
	...
	<div class="row">
		<div class="col-sm-12 justify-content-between">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica" type="checkbox" value="2">
	...
	<div class="row">
		<div class="col-sm-12 justify-content-between">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica" type="checkbox" value="3">
	...
	<div class="row">
		<div class="col-sm-12 justify-content-between">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica" type="checkbox" value="4">
	...
	<div class="row">
		<div class="col-sm-12 justify-content-between">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica" type="checkbox" value="5">
	...
	<div class="row">
		<div class="col-sm-12 justify-content-between">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica" type="checkbox" value="6">
	...
	<div class="row">
		<div class="col-sm-12 justify-content-between">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica" type="checkbox" value="7">
	...
	<div class="row">
		<div class="col-sm-12 justify-content-between">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica" type="checkbox" value="8">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica" type="checkbox" value="10">
	...
	<div class="row">
		...
		<div class="col-sm-12">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica" type="radio" value="1">
				<label class="form-check-label" for="biomedica">Destrucción.</label>
			</div>
		</div>
		<div class="col-sm-12">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica" type="radio" value="2">
				<label class="form-check-label" for="biomedica">Incorporación a una colección registrada. Nombre de la
					colección.</label>
			</div>
			<div class="form-check form-check-inline" style="margin: 10px 0;">
				<textarea name="biomedica" id="nuevo-proy-textarea" cols="1996" rows="1"
					style="width: 100%; padding: 5px;"></textarea>
			</div>
		</div>
		<div class="col-sm-12">
			<div class="form-check form-check-inline">
				<input class="form-check-input" name="biomedica" type="radio" value="3">
