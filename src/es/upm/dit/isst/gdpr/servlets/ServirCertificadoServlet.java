...
@WebServlet({ "/ServirCertificadoServlet" })
public class ServirCertificadoServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.setContentLength(solicitud.getCertificado().length);
		resp.getOutputStream().write(solicitud.getCertificado());
	}
